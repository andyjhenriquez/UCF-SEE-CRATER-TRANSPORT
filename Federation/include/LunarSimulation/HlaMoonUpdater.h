 ...
 */
#ifndef DEVELOPER_STUDIO_HLAMOONUPDATER_H
#define DEVELOPER_STUDIO_HLAMOONUPDATER_H
...
namespace LunarSimulation {
    ...
    */
    class HlaMoonUpdater : public HlaReferenceFrameUpdater {

    public:

    LIBAPI virtual ~HlaMoonUpdater() {}
