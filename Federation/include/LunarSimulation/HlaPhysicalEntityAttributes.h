 ...
 */
#ifndef DEVELOPER_STUDIO_HLAPHYSICALENTITYATTRIBUTES_H
#define DEVELOPER_STUDIO_HLAPHYSICALENTITYATTRIBUTES_H
...
namespace LunarSimulation {
   ...
   */
   class HlaPhysicalEntityAttributes : public HlaHLAobjectRootAttributes {
   public:
      ...
      */
      ...
      LIBAPI virtual ~HlaPhysicalEntityAttributes() {}
