 ...
 */
#ifndef DEVELOPER_STUDIO_HLAPHYSICALENTITY_H
#define DEVELOPER_STUDIO_HLAPHYSICALENTITY_H
...
namespace LunarSimulation {
    ...
    */
    class HlaPhysicalEntity : public HlaPhysicalEntityAttributes , public HlaObjectInstanceBase {

    public:

        /**
        * Tells if this HlaPhysicalEntity object is local or remote.
        ...
        */
        LIBAPI virtual HlaPhysicalEntityAttributesPtr getHlaPhysicalEntityAttributes() = 0;
        ...
        */
        LIBAPI virtual HlaPhysicalEntityUpdaterPtr getHlaPhysicalEntityUpdater() = 0;
        ...
        * use: @link HlaPhysicalEntityManager#addHlaPhysicalEntityDefaultInstanceListener(HlaPhysicalEntityListenerPtr listener)@endlink.
        *
        * @param listener The listener to add.
        */
        LIBAPI virtual void addHlaPhysicalEntityListener(HlaPhysicalEntityListenerPtr listener) = 0;
        ...
        */
        LIBAPI virtual void removeHlaPhysicalEntityListener(HlaPhysicalEntityListenerPtr listener) = 0;
        ...
        *
        * To make sure that no attribute updates arrive before adding the listener,
        * use: @link HlaPhysicalEntityManager#addHlaPhysicalEntityDefaultInstanceValueListener(HlaPhysicalEntityValueListenerPtr valueListener)@endlink.
        *
        * @param valueListener The valueListener to add.
        */
        LIBAPI virtual void addHlaPhysicalEntityValueListener(HlaPhysicalEntityValueListenerPtr valueListener) = 0;
        ...
        */
        LIBAPI virtual void removeHlaPhysicalEntityValueListener(HlaPhysicalEntityValueListenerPtr valueListener) = 0;
        ...
        */
        LIBAPI virtual HlaFederateIdPtr getLastProducingFederate(HlaPhysicalEntityAttributes::Attribute attribute) = 0;
    };
}
#endif
