 ...
 */
#ifndef DEVELOPER_STUDIO_HLAMOONATTRIBUTES_H
#define DEVELOPER_STUDIO_HLAMOONATTRIBUTES_H
...
namespace LunarSimulation {
   ...
   */
   class HlaMoonAttributes : public HlaReferenceFrameAttributes {
   public:
      ...
      */
      ...
      LIBAPI virtual ~HlaMoonAttributes() {}
