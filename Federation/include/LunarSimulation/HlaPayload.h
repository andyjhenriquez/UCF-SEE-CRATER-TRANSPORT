 ...
 */
#ifndef DEVELOPER_STUDIO_HLAPAYLOAD_H
#define DEVELOPER_STUDIO_HLAPAYLOAD_H
...
namespace LunarSimulation {
    ...
    */
    class HlaPayload : public HlaPayloadAttributes , public HlaObjectInstanceBase {

    public:

        /**
        * Tells if this HlaPayload object is local or remote.
        ...
        */
        LIBAPI virtual HlaPayloadAttributesPtr getHlaPayloadAttributes() = 0;
        ...
        */
        LIBAPI virtual HlaPayloadUpdaterPtr getHlaPayloadUpdater() = 0;
        ...
        * use: @link HlaPayloadManager#addHlaPayloadDefaultInstanceListener(HlaPayloadListenerPtr listener)@endlink.
        *
        * @param listener The listener to add.
        */
        LIBAPI virtual void addHlaPayloadListener(HlaPayloadListenerPtr listener) = 0;
        ...
        */
        LIBAPI virtual void removeHlaPayloadListener(HlaPayloadListenerPtr listener) = 0;
        ...
        *
        * To make sure that no attribute updates arrive before adding the listener,
        * use: @link HlaPayloadManager#addHlaPayloadDefaultInstanceValueListener(HlaPayloadValueListenerPtr valueListener)@endlink.
        *
        * @param valueListener The valueListener to add.
        */
        LIBAPI virtual void addHlaPayloadValueListener(HlaPayloadValueListenerPtr valueListener) = 0;
        ...
        */
        LIBAPI virtual void removeHlaPayloadValueListener(HlaPayloadValueListenerPtr valueListener) = 0;
        ...
        */
        LIBAPI virtual HlaFederateIdPtr getLastProducingFederate(HlaPayloadAttributes::Attribute attribute) = 0;
    };
}
#endif
