 ...
 */
#ifndef DEVELOPER_STUDIO_HLAPAYLOADUPDATER_H
#define DEVELOPER_STUDIO_HLAPAYLOADUPDATER_H
...
namespace LunarSimulation {
    ...
    */
    class HlaPayloadUpdater : public HlaDynamicalEntityUpdater {

    public:

    LIBAPI virtual ~HlaPayloadUpdater() {}
    ...
    */
    LIBAPI virtual void setVelocity(const std::vector</* 3 */ double >& velocity) = 0;
    ...
    */
    LIBAPI virtual void setHealth(const double& health) = 0;
    ...
    */
    LIBAPI virtual void setForce(const std::vector</* 3 */ double >& force) = 0;
    ...
    */
    LIBAPI virtual void setTorque(const std::vector</* 3 */ double >& torque) = 0;
    ...
    */
    LIBAPI virtual void setMass(const double& mass) = 0;
    ...
    */
    LIBAPI virtual void setMassRate(const double& massRate) = 0;
    ...
    */
    LIBAPI virtual void setInertia(const std::vector</* 9 */ double >& inertia) = 0;
    ...
    */
    LIBAPI virtual void setInertiaRate(const std::vector</* 9 */ double >& inertiaRate) = 0;
