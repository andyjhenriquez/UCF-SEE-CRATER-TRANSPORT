 ...
 */
#ifndef DEVELOPER_STUDIO_HLAPHYSICALENTITYVALUELISTENER_H
#define DEVELOPER_STUDIO_HLAPHYSICALENTITYVALUELISTENER_H
...
namespace LunarSimulation {
   ...
   */
   ...
   public:
      ...
      LIBAPI virtual ~HlaPhysicalEntityValueListener() {}
      ...
      */
      LIBAPI virtual void nameUpdated(HlaPhysicalEntityPtr physicalEntity, std::wstring name, bool validOldName, std::wstring oldName, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void typeUpdated(HlaPhysicalEntityPtr physicalEntity, std::wstring type, bool validOldType, std::wstring oldType, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void statusUpdated(HlaPhysicalEntityPtr physicalEntity, std::wstring status, bool validOldStatus, std::wstring oldStatus, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void parentReferenceFrameUpdated(HlaPhysicalEntityPtr physicalEntity, std::wstring parentReferenceFrame, bool validOldParentReferenceFrame, std::wstring oldParentReferenceFrame, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void stateUpdated(HlaPhysicalEntityPtr physicalEntity, SpaceTimeCoordinateState state, bool validOldState, SpaceTimeCoordinateState oldState, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void accelerationUpdated(HlaPhysicalEntityPtr physicalEntity, std::vector</* 3 */ double > acceleration, bool validOldAcceleration, std::vector</* 3 */ double > oldAcceleration, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
...
projected.
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void rotationalAccelerationUpdated(HlaPhysicalEntityPtr physicalEntity, std::vector</* 3 */ double > rotationalAcceleration, bool validOldRotationalAcceleration, std::vector</* 3 */ double > oldRotationalAcceleration, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void centerOfMassUpdated(HlaPhysicalEntityPtr physicalEntity, std::vector</* 3 */ double > centerOfMass, bool validOldCenterOfMass, std::vector</* 3 */ double > oldCenterOfMass, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void bodyWrtStructuralUpdated(HlaPhysicalEntityPtr physicalEntity, AttitudeQuaternion bodyWrtStructural, bool validOldBodyWrtStructural, AttitudeQuaternion oldBodyWrtStructural, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      /**
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void producingFederateUpdated(HlaPhysicalEntityPtr physicalEntity, HlaPhysicalEntityAttributes::Attribute attribute, HlaFederateIdPtr oldProducingFederate, HlaFederateIdPtr newProducingFederate, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;

      class Adapter;
   };

   /**
   * An adapter class that implements the HlaPhysicalEntityValueListener interface with empty methods.
   * It might be used as a base class for a listener.
   */
   class HlaPhysicalEntityValueListener::Adapter : public HlaPhysicalEntityValueListener {

   public:

      LIBAPI virtual void nameUpdated(HlaPhysicalEntityPtr physicalEntity, std::wstring name, bool validOldName, std::wstring oldName, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void typeUpdated(HlaPhysicalEntityPtr physicalEntity, std::wstring type, bool validOldType, std::wstring oldType, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void statusUpdated(HlaPhysicalEntityPtr physicalEntity, std::wstring status, bool validOldStatus, std::wstring oldStatus, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void parentReferenceFrameUpdated(HlaPhysicalEntityPtr physicalEntity, std::wstring parentReferenceFrame, bool validOldParentReferenceFrame, std::wstring oldParentReferenceFrame, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void stateUpdated(HlaPhysicalEntityPtr physicalEntity, SpaceTimeCoordinateState state, bool validOldState, SpaceTimeCoordinateState oldState, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void accelerationUpdated(HlaPhysicalEntityPtr physicalEntity, std::vector</* 3 */ double > acceleration, bool validOldAcceleration, std::vector</* 3 */ double > oldAcceleration, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void rotationalAccelerationUpdated(HlaPhysicalEntityPtr physicalEntity, std::vector</* 3 */ double > rotationalAcceleration, bool validOldRotationalAcceleration, std::vector</* 3 */ double > oldRotationalAcceleration, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void centerOfMassUpdated(HlaPhysicalEntityPtr physicalEntity, std::vector</* 3 */ double > centerOfMass, bool validOldCenterOfMass, std::vector</* 3 */ double > oldCenterOfMass, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void bodyWrtStructuralUpdated(HlaPhysicalEntityPtr physicalEntity, AttitudeQuaternion bodyWrtStructural, bool validOldBodyWrtStructural, AttitudeQuaternion oldBodyWrtStructural, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}
      LIBAPI virtual void producingFederateUpdated(HlaPhysicalEntityPtr physicalEntity, HlaPhysicalEntityAttributes::Attribute attribute, HlaFederateIdPtr oldProducingFederate, HlaFederateIdPtr newProducingFederate, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}
   };
