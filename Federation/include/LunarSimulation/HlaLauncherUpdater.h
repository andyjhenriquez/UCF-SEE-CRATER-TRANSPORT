 ...
 */
#ifndef DEVELOPER_STUDIO_HLALAUNCHERUPDATER_H
#define DEVELOPER_STUDIO_HLALAUNCHERUPDATER_H
...
namespace LunarSimulation {
    ...
    */
    class HlaLauncherUpdater : public HlaPhysicalEntityUpdater {

    public:

    LIBAPI virtual ~HlaLauncherUpdater() {}
