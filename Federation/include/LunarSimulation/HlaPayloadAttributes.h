 ...
 */
#ifndef DEVELOPER_STUDIO_HLAPAYLOADATTRIBUTES_H
#define DEVELOPER_STUDIO_HLAPAYLOADATTRIBUTES_H
...
namespace LunarSimulation {
   ...
   */
   class HlaPayloadAttributes : public HlaDynamicalEntityAttributes {
   public:


     /**
      * An enumeration of the attributes of an HlaPayload
      *
      *<table>
      ...
      * <tr><td>VELOCITY</td><td>velocity</td><td><code>velocity</code></td></tr>
      * <tr><td>HEALTH</td><td>health</td><td><code>health</code></td></tr>
      ...
      */
      enum Attribute {
        ...
        */
        ...
        /**
        * velocity (FOM name: <code>velocity</code>).
        * <br>Description from the FOM: payload velocity
        */
         VELOCITY,

        /**
        * health (FOM name: <code>health</code>).
      ...
      */
      ...
      LIBAPI virtual ~HlaPayloadAttributes() {}
      ...
      */
      ...
      /**
      * Returns true if the <code>velocity</code> attribute has received a value yet.
      *
      * <br>Description from the FOM: payload velocity
      *
      * @return true if <code>velocity</code> is available.
      */
      LIBAPI virtual bool hasVelocity() = 0;

      /**
      * Gets the value of the <code>velocity</code> attribute.
      *
      * <br>Description from the FOM: payload velocity
      ...
      *
      * @return the <code>velocity</code> attribute.
      *
      * @throws HlaValueNotSetException unchecked exception that is thrown if no value is available.
      */
      LIBAPI virtual std::vector</* 3 */ double > getVelocity()
         THROW_SPEC (HlaValueNotSetException) = 0;

      /**
      * Gets the value of the <code>velocity</code> attribute, or <code>defaultValue</code> if value was not set.
      *
      * <br>Description from the FOM: payload velocity
      * <br>Description of the data type from the FOM: A 3-vector that specifies the time derivative of the vector position of some point with respect to another as seen by an observer fixed in some reference frame. This data type does not specify which points are involved, nor does it specify the observer frame of reference, nor does it specify the coordinate axes onto which the three components of the vector are projected.
      *
      ...
      * @return the <code>velocity</code> attribute.
      */
      LIBAPI virtual std::vector</* 3 */ double > getVelocity(std::vector</* 3 */ double > defaultValue) = 0;

      /**
      * Gets the time stamped value of the <code>velocity</code> attribute.
      * <br>Description from the FOM: payload velocity
      * <br>Description of the data type from the FOM: A 3-vector that specifies the time derivative of the vector position of some point with respect to another as seen by an observer fixed in some reference frame. This data type does not specify which points are involved, nor does it specify the observer frame of reference, nor does it specify the coordinate axes onto which the three components of the vector are projected.
      *
      * @return the time stamped <code>velocity</code> attribute.
      *
      * @throws HlaValueNotSetException unchecked exception that is thrown if no value is available.
      */
      LIBAPI virtual LunarSimulation::HlaTimeStamped< std::vector</* 3 */ double > > getVelocityTimeStamped()
         THROW_SPEC (HlaValueNotSetException) = 0;
    
      /**
      * Returns true if the <code>health</code> attribute has received a value yet.
      *
      * <br>Description from the FOM: Scalar representing health
      *
      * @return true if <code>health</code> is available.
      */
      LIBAPI virtual bool hasHealth() = 0;

      /**
      * Gets the value of the <code>health</code> attribute.
      *
      * <br>Description from the FOM: Scalar representing health
      * <br>Description of the data type from the FOM: Scalar representing health [unit: NA]
      *
      * @return the <code>health</code> attribute.
      *
      * @throws HlaValueNotSetException unchecked exception that is thrown if no value is available.
      */
      LIBAPI virtual double getHealth()
         THROW_SPEC (HlaValueNotSetException) = 0;

      /**
      * Gets the value of the <code>health</code> attribute, or <code>defaultValue</code> if value was not set.
      *
      * <br>Description from the FOM: Scalar representing health
      * <br>Description of the data type from the FOM: Scalar representing health [unit: NA]
      *
      ...
      * @return the <code>health</code> attribute.
      */
      LIBAPI virtual double getHealth(double defaultValue) = 0;

      /**
      * Gets the time stamped value of the <code>health</code> attribute.
      * <br>Description from the FOM: Scalar representing health
      * <br>Description of the data type from the FOM: Scalar representing health [unit: NA]
      *
      * @return the time stamped <code>health</code> attribute.
      *
      * @throws HlaValueNotSetException unchecked exception that is thrown if no value is available.
      */
      LIBAPI virtual LunarSimulation::HlaTimeStamped< double > getHealthTimeStamped()
         THROW_SPEC (HlaValueNotSetException) = 0;
