 ...
 */
#ifndef DEVELOPER_STUDIO_HLAREFERENCEFRAMEVALUELISTENER_H
#define DEVELOPER_STUDIO_HLAREFERENCEFRAMEVALUELISTENER_H
...
namespace LunarSimulation {
   ...
   */
   ...
   public:
      ...
      LIBAPI virtual ~HlaReferenceFrameValueListener() {}
      ...
      */
      LIBAPI virtual void nameUpdated(HlaReferenceFramePtr referenceFrame, std::wstring name, bool validOldName, std::wstring oldName, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void parentNameUpdated(HlaReferenceFramePtr referenceFrame, std::wstring parentName, bool validOldParentName, std::wstring oldParentName, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void stateUpdated(HlaReferenceFramePtr referenceFrame, SpaceTimeCoordinateState state, bool validOldState, SpaceTimeCoordinateState oldState, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      /**
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void producingFederateUpdated(HlaReferenceFramePtr referenceFrame, HlaReferenceFrameAttributes::Attribute attribute, HlaFederateIdPtr oldProducingFederate, HlaFederateIdPtr newProducingFederate, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;

      class Adapter;
   };

   /**
   * An adapter class that implements the HlaReferenceFrameValueListener interface with empty methods.
   * It might be used as a base class for a listener.
   */
   class HlaReferenceFrameValueListener::Adapter : public HlaReferenceFrameValueListener {

   public:

      LIBAPI virtual void nameUpdated(HlaReferenceFramePtr referenceFrame, std::wstring name, bool validOldName, std::wstring oldName, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void parentNameUpdated(HlaReferenceFramePtr referenceFrame, std::wstring parentName, bool validOldParentName, std::wstring oldParentName, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void stateUpdated(HlaReferenceFramePtr referenceFrame, SpaceTimeCoordinateState state, bool validOldState, SpaceTimeCoordinateState oldState, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}
      LIBAPI virtual void producingFederateUpdated(HlaReferenceFramePtr referenceFrame, HlaReferenceFrameAttributes::Attribute attribute, HlaFederateIdPtr oldProducingFederate, HlaFederateIdPtr newProducingFederate, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}
   };
