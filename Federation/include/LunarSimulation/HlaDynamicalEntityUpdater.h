 ...
 */
#ifndef DEVELOPER_STUDIO_HLADYNAMICALENTITYUPDATER_H
#define DEVELOPER_STUDIO_HLADYNAMICALENTITYUPDATER_H
...
namespace LunarSimulation {
    ...
    */
    class HlaDynamicalEntityUpdater : public HlaPhysicalEntityUpdater {

    public:

    LIBAPI virtual ~HlaDynamicalEntityUpdater() {}
