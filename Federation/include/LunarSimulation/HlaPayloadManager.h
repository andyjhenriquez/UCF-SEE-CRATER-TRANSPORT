   ...
   */
   ...
   public:
      ...
      */
      ...
      /**
      * Find a HlaPayload with the given <code>name</code>.
      * If more than one HlaPayload with the given <code>name</code> is present, one of
      ...
      *
      * @param name The name that looks up which HlaPayload to return.
      *
      * @return an HlaPayload, or <code>null</code> if not found.
      */
      LIBAPI virtual HlaPayloadPtr getPayloadByName(std::wstring name) = 0;
