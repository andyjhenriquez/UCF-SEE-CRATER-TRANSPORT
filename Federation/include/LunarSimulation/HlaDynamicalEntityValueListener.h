 ...
 */
#ifndef DEVELOPER_STUDIO_HLADYNAMICALENTITYVALUELISTENER_H
#define DEVELOPER_STUDIO_HLADYNAMICALENTITYVALUELISTENER_H
...
namespace LunarSimulation {
   ...
   */
   ...
   public:
      ...
      LIBAPI virtual ~HlaDynamicalEntityValueListener() {}
      ...
      */
      LIBAPI virtual void forceUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 3 */ double > force, bool validOldForce, std::vector</* 3 */ double > oldForce, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void torqueUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 3 */ double > torque, bool validOldTorque, std::vector</* 3 */ double > oldTorque, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void massUpdated(HlaDynamicalEntityPtr dynamicalEntity, double mass, bool validOldMass, double oldMass, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void massRateUpdated(HlaDynamicalEntityPtr dynamicalEntity, double massRate, bool validOldMassRate, double oldMassRate, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void inertiaUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 9 */ double > inertia, bool validOldInertia, std::vector</* 9 */ double > oldInertia, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void inertiaRateUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 9 */ double > inertiaRate, bool validOldInertiaRate, std::vector</* 9 */ double > oldInertiaRate, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void nameUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::wstring name, bool validOldName, std::wstring oldName, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void typeUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::wstring type, bool validOldType, std::wstring oldType, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void statusUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::wstring status, bool validOldStatus, std::wstring oldStatus, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void parentReferenceFrameUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::wstring parentReferenceFrame, bool validOldParentReferenceFrame, std::wstring oldParentReferenceFrame, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void stateUpdated(HlaDynamicalEntityPtr dynamicalEntity, SpaceTimeCoordinateState state, bool validOldState, SpaceTimeCoordinateState oldState, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void accelerationUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 3 */ double > acceleration, bool validOldAcceleration, std::vector</* 3 */ double > oldAcceleration, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
...
projected.
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void rotationalAccelerationUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 3 */ double > rotationalAcceleration, bool validOldRotationalAcceleration, std::vector</* 3 */ double > oldRotationalAcceleration, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void centerOfMassUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 3 */ double > centerOfMass, bool validOldCenterOfMass, std::vector</* 3 */ double > oldCenterOfMass, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void bodyWrtStructuralUpdated(HlaDynamicalEntityPtr dynamicalEntity, AttitudeQuaternion bodyWrtStructural, bool validOldBodyWrtStructural, AttitudeQuaternion oldBodyWrtStructural, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;
      /**
      ...
      * @param logicalTime The logical time when the update was initiated.
      */
      LIBAPI virtual void producingFederateUpdated(HlaDynamicalEntityPtr dynamicalEntity, HlaDynamicalEntityAttributes::Attribute attribute, HlaFederateIdPtr oldProducingFederate, HlaFederateIdPtr newProducingFederate, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime)=0;

      class Adapter;
   };

   /**
   * An adapter class that implements the HlaDynamicalEntityValueListener interface with empty methods.
   * It might be used as a base class for a listener.
   */
   class HlaDynamicalEntityValueListener::Adapter : public HlaDynamicalEntityValueListener {

   public:

      LIBAPI virtual void forceUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 3 */ double > force, bool validOldForce, std::vector</* 3 */ double > oldForce, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void torqueUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 3 */ double > torque, bool validOldTorque, std::vector</* 3 */ double > oldTorque, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void massUpdated(HlaDynamicalEntityPtr dynamicalEntity, double mass, bool validOldMass, double oldMass, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void massRateUpdated(HlaDynamicalEntityPtr dynamicalEntity, double massRate, bool validOldMassRate, double oldMassRate, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void inertiaUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 9 */ double > inertia, bool validOldInertia, std::vector</* 9 */ double > oldInertia, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void inertiaRateUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 9 */ double > inertiaRate, bool validOldInertiaRate, std::vector</* 9 */ double > oldInertiaRate, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void nameUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::wstring name, bool validOldName, std::wstring oldName, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void typeUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::wstring type, bool validOldType, std::wstring oldType, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void statusUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::wstring status, bool validOldStatus, std::wstring oldStatus, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void parentReferenceFrameUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::wstring parentReferenceFrame, bool validOldParentReferenceFrame, std::wstring oldParentReferenceFrame, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void stateUpdated(HlaDynamicalEntityPtr dynamicalEntity, SpaceTimeCoordinateState state, bool validOldState, SpaceTimeCoordinateState oldState, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void accelerationUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 3 */ double > acceleration, bool validOldAcceleration, std::vector</* 3 */ double > oldAcceleration, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void rotationalAccelerationUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 3 */ double > rotationalAcceleration, bool validOldRotationalAcceleration, std::vector</* 3 */ double > oldRotationalAcceleration, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void centerOfMassUpdated(HlaDynamicalEntityPtr dynamicalEntity, std::vector</* 3 */ double > centerOfMass, bool validOldCenterOfMass, std::vector</* 3 */ double > oldCenterOfMass, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}

      LIBAPI virtual void bodyWrtStructuralUpdated(HlaDynamicalEntityPtr dynamicalEntity, AttitudeQuaternion bodyWrtStructural, bool validOldBodyWrtStructural, AttitudeQuaternion oldBodyWrtStructural, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}
      LIBAPI virtual void producingFederateUpdated(HlaDynamicalEntityPtr dynamicalEntity, HlaDynamicalEntityAttributes::Attribute attribute, HlaFederateIdPtr oldProducingFederate, HlaFederateIdPtr newProducingFederate, HlaTimeStampPtr timeStamp, HlaLogicalTimePtr logicalTime) {}
   };
