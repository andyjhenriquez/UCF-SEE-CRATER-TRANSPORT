 ...
 */
#ifndef DEVELOPER_STUDIO_HLAEXECUTIONCONFIGURATION_H
#define DEVELOPER_STUDIO_HLAEXECUTIONCONFIGURATION_H
...
namespace LunarSimulation {
    ...
    */
    class HlaExecutionConfiguration : public HlaExecutionConfigurationAttributes , public HlaObjectInstanceBase {

    public:

        /**
        * Tells if this HlaExecutionConfiguration object is local or remote.
        ...
        */
        LIBAPI virtual HlaExecutionConfigurationAttributesPtr getHlaExecutionConfigurationAttributes() = 0;
        ...
        */
        LIBAPI virtual HlaExecutionConfigurationUpdaterPtr getHlaExecutionConfigurationUpdater() = 0;
        ...
        * use: @link HlaExecutionConfigurationManager#addHlaExecutionConfigurationDefaultInstanceListener(HlaExecutionConfigurationListenerPtr listener)@endlink.
        *
        * @param listener The listener to add.
        */
        LIBAPI virtual void addHlaExecutionConfigurationListener(HlaExecutionConfigurationListenerPtr listener) = 0;
        ...
        */
        LIBAPI virtual void removeHlaExecutionConfigurationListener(HlaExecutionConfigurationListenerPtr listener) = 0;
        ...
        *
        * To make sure that no attribute updates arrive before adding the listener,
        * use: @link HlaExecutionConfigurationManager#addHlaExecutionConfigurationDefaultInstanceValueListener(HlaExecutionConfigurationValueListenerPtr valueListener)@endlink.
        *
        * @param valueListener The valueListener to add.
        */
        LIBAPI virtual void addHlaExecutionConfigurationValueListener(HlaExecutionConfigurationValueListenerPtr valueListener) = 0;
        ...
        */
        LIBAPI virtual void removeHlaExecutionConfigurationValueListener(HlaExecutionConfigurationValueListenerPtr valueListener) = 0;
        ...
        */
        LIBAPI virtual HlaFederateIdPtr getLastProducingFederate(HlaExecutionConfigurationAttributes::Attribute attribute) = 0;
    };
}
#endif
