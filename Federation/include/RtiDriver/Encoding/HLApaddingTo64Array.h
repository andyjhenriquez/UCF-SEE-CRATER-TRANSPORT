...
***********************************************************************/
#ifndef DS_DRIVER_RTI_HLApaddingTo64Array_h_
#define DS_DRIVER_RTI_HLApaddingTo64Array_h_
...
namespace EncodingHelpers {
   ...
   class HLApaddingTo64ArrayImplementation;

   // Interface for the HLAvariableArray complex data element
   class RTIDRIVER_EXPORT HLApaddingTo64Array : public EncodingHelpers::DataElement
   {
   public:
      ...
      explicit HLApaddingTo64Array (
         const DataElement& prototype );

      // Copy Constructor
      HLApaddingTo64Array (
         HLApaddingTo64Array const & rhs);

      // Destructor
      virtual ~HLApaddingTo64Array ();
   ...
   private:
      ...
      HLApaddingTo64Array& operator=(
         HLApaddingTo64Array const & rhs);

   protected:

      HLApaddingTo64ArrayImplementation* _impl;
   };
}

#endif // DS_DRIVER_RTI_HLApaddingTo64Array_h_
