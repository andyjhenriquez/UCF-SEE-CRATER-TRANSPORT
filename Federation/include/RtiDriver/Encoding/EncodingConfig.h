...
***********************************************************************/
#ifndef DS_DRIVER_RTI_EncodingConfig_h_
#define DS_DRIVER_RTI_EncodingConfig_h_
...
namespace EncodingHelpers {
   ...
   typedef unsigned short     UnsignedInteger16;
   typedef unsigned int       UnsignedInteger32;
   typedef unsigned long      UnsignedInteger64;
#else
   typedef char      Integer8;
   typedef short     Integer16;
   typedef int       Integer32;
...
#endif // DS_DRIVER_RTI_EncodingConfig_h_
