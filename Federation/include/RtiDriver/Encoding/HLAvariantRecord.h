...
***********************************************************************/
#ifndef DS_DRIVER_RTI_HLAvariantRecord_h_
#define DS_DRIVER_RTI_HLAvariantRecord_h_
...
namespace EncodingHelpers {
   ...
   class RTIDRIVER_EXPORT HLAvariantRecord : public EncodingHelpers::DataElement
   {
   public:
...
#endif // DS_DRIVER_RTI_HLAvariantRecord_h_
