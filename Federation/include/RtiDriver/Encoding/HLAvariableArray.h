...
***********************************************************************/
#ifndef DS_DRIVER_RTI_HLAvariableArray_h_
#define DS_DRIVER_RTI_HLAvariableArray_h_
...
namespace EncodingHelpers {
   ...
   class RTIDRIVER_EXPORT HLAvariableArray : public EncodingHelpers::DataElement
   {
   public:
...
#endif // DS_DRIVER_RTI_HLAvariableArray_h_
