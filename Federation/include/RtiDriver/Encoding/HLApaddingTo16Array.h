...
***********************************************************************/
#ifndef DS_DRIVER_RTI_HLApaddingTo16Array_h_
#define DS_DRIVER_RTI_HLApaddingTo16Array_h_
...
namespace EncodingHelpers {
   ...
   class HLApaddingTo16ArrayImplementation;

   // Interface for the HLAvariableArray complex data element
   class RTIDRIVER_EXPORT HLApaddingTo16Array : public EncodingHelpers::DataElement
   {
   public:
      ...
      explicit HLApaddingTo16Array (
         const DataElement& prototype );

      // Copy Constructor
      HLApaddingTo16Array (
         HLApaddingTo16Array const & rhs);

      // Destructor
      virtual ~HLApaddingTo16Array ();
   ...
   private:
      ...
      HLApaddingTo16Array& operator=(
         HLApaddingTo16Array const & rhs);

   protected:

      HLApaddingTo16ArrayImplementation* _impl;
   };
}

#endif // DS_DRIVER_RTI_HLApaddingTo16Array_h_
