...
***********************************************************************/
#ifndef DS_DRIVER_RTI_HLApaddingTo32Array_h_
#define DS_DRIVER_RTI_HLApaddingTo32Array_h_
...
namespace EncodingHelpers {
   ...
   class HLApaddingTo32ArrayImplementation;

   // Interface for the HLAvariableArray complex data element
   class RTIDRIVER_EXPORT HLApaddingTo32Array : public EncodingHelpers::DataElement
   {
   public:
      ...
      explicit HLApaddingTo32Array (
         const DataElement& prototype );

      // Copy Constructor
      HLApaddingTo32Array (
         HLApaddingTo32Array const & rhs);

      // Destructor
      virtual ~HLApaddingTo32Array ();
   ...
   private:
      ...
      HLApaddingTo32Array& operator=(
         HLApaddingTo32Array const & rhs);

   protected:

      HLApaddingTo32ArrayImplementation* _impl;
   };
}

#endif // DS_DRIVER_RTI_HLApaddingTo32Array_h_
