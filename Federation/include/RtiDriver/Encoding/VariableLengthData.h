...
#ifndef DS_DRIVER_RTI_VariableLengthData_h
#define DS_DRIVER_RTI_VariableLengthData_h
...
namespace EncodingHelpers {
   ...
   class RTIDRIVER_EXPORT VariableLengthData
   {
   public:
      VariableLengthData ();
...
#endif // DS_DRIVER_RTI_VariableLengthData_h
