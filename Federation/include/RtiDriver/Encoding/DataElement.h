...
/***********************************************************************
   ...
   File: DataElement.h
***********************************************************************/
#ifndef DS_DRIVER_RTI_DataElement_h_
#define DS_DRIVER_RTI_DataElement_h_

#include "EncodingExceptions.h"
...
namespace EncodingHelpers {
   ...
   class RTIDRIVER_EXPORT DataElement
   {
   public:
      ...
      virtual VariableLengthData encode () const
         RTI_DRIVER_THROW_SPEC(EncoderException) = 0;
...
#endif // DS_DRIVER_RTI_DataElement_h_
