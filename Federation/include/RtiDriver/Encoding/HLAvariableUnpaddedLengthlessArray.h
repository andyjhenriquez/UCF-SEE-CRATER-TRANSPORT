...
***********************************************************************/
#ifndef DS_DRIVER_RTI_HLAvariableUnpaddedLengthlessArray_h_
#define DS_DRIVER_RTI_HLAvariableUnpaddedLengthlessArray_h_
...
namespace EncodingHelpers {
   ...
   class HLAvariableUnpaddedLengthlessArrayImplementation;

   // Interface for the HLAvariableArray complex data element
   class RTIDRIVER_EXPORT HLAvariableUnpaddedLengthlessArray : public EncodingHelpers::DataElement
   {
   public:
      ...
      explicit HLAvariableUnpaddedLengthlessArray (
         const DataElement& prototype );

      // Copy Constructor
      HLAvariableUnpaddedLengthlessArray (
         HLAvariableUnpaddedLengthlessArray const & rhs);

      // Destructor
      virtual ~HLAvariableUnpaddedLengthlessArray ();
   ...
   private:
      ...
      HLAvariableUnpaddedLengthlessArray& operator=(
         HLAvariableUnpaddedLengthlessArray const & rhs);

   protected:

      HLAvariableUnpaddedLengthlessArrayImplementation* _impl;
   };
}

#endif // DS_DRIVER_RTI_HLAvariableUnpaddedLengthlessArray_h_
