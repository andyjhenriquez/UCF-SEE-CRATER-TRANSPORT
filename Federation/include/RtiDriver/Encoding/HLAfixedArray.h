...
***********************************************************************/
#ifndef DS_DRIVER_RTI_HLAfixedArray_h_
#define DS_DRIVER_RTI_HLAfixedArray_h_
...
namespace EncodingHelpers {
   ...
   class RTIDRIVER_EXPORT HLAfixedArray : public EncodingHelpers::DataElement
   {
   public:
...
#endif // DS_DRIVER_RTI_HLAfixedArray_h_
