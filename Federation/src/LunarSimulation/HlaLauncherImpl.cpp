...
void HlaLauncherImpl::setCreateAttributes(
    ...
    try {
        ...
        HlaExceptionPtr ex(new HlaInternalException(L"Failed to set create attributes in HlaLauncherImpl" + e.what_w()));
