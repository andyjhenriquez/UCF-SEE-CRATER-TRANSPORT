 ...
 */
#ifndef DEVELOPER_STUDIO_HLAREFERENCEFRAMEATTRIBUTESIMPL_H
#define DEVELOPER_STUDIO_HLAREFERENCEFRAMEATTRIBUTESIMPL_H
...
namespace LunarSimulation {
    ...
    class HlaReferenceFrameAttributesImpl : public HlaReferenceFrameAttributes {
    public:
