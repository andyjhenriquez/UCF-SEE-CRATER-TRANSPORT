...
void HlaPayloadImpl::setCreateAttributes(
    ...
    try {
        ...
        HlaExceptionPtr ex(new HlaInternalException(L"Failed to set create attributes in HlaPayloadImpl" + e.what_w()));
