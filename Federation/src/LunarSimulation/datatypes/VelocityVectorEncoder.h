 ...
 */
#ifndef DEVELOPER_STUDIO_DATATYPES_VELOCITYVECTORENCODER_H
#define DEVELOPER_STUDIO_DATATYPES_VELOCITYVECTORENCODER_H
...
namespace LunarSimulation {
    ...
    class VelocityVectorEncoder :public EncodingHelpers::AbstractDataElement{

    public:
        VelocityVectorEncoder();

        VelocityVectorEncoder(const VelocityVectorEncoder & rhs);

        explicit VelocityVectorEncoder(const std::vector<double > & v)
