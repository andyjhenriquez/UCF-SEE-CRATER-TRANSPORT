 ...
 */
#ifndef DEVELOPER_STUDIO_DATATYPES_ANGULARVELOCITYVECTORENCODER_H
#define DEVELOPER_STUDIO_DATATYPES_ANGULARVELOCITYVECTORENCODER_H
...
namespace LunarSimulation {
    ...
    class AngularVelocityVectorEncoder :public EncodingHelpers::AbstractDataElement{

    public:
        AngularVelocityVectorEncoder();

        AngularVelocityVectorEncoder(const AngularVelocityVectorEncoder & rhs);

        explicit AngularVelocityVectorEncoder(const std::vector<double > & v)
