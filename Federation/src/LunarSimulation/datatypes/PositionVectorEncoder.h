 ...
 */
#ifndef DEVELOPER_STUDIO_DATATYPES_POSITIONVECTORENCODER_H
#define DEVELOPER_STUDIO_DATATYPES_POSITIONVECTORENCODER_H
...
namespace LunarSimulation {
    ...
    class PositionVectorEncoder :public EncodingHelpers::AbstractDataElement{

    public:
        PositionVectorEncoder();

        PositionVectorEncoder(const PositionVectorEncoder & rhs);

        explicit PositionVectorEncoder(const std::vector<double > & v)
