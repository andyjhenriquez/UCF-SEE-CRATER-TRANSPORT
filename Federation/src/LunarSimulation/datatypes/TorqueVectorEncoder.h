 ...
 */
#ifndef DEVELOPER_STUDIO_DATATYPES_TORQUEVECTORENCODER_H
#define DEVELOPER_STUDIO_DATATYPES_TORQUEVECTORENCODER_H
...
namespace LunarSimulation {
    ...
    class TorqueVectorEncoder :public EncodingHelpers::AbstractDataElement{

    public:
        TorqueVectorEncoder();

        TorqueVectorEncoder(const TorqueVectorEncoder & rhs);

        explicit TorqueVectorEncoder(const std::vector<double > & v)
