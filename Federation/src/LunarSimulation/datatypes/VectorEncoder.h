 ...
 */
#ifndef DEVELOPER_STUDIO_DATATYPES_VECTORENCODER_H
#define DEVELOPER_STUDIO_DATATYPES_VECTORENCODER_H
...
namespace LunarSimulation {
    ...
    class VectorEncoder :public EncodingHelpers::AbstractDataElement{

    public:
        VectorEncoder();

        VectorEncoder(const VectorEncoder & rhs);

        explicit VectorEncoder(const std::vector<double > & v)
