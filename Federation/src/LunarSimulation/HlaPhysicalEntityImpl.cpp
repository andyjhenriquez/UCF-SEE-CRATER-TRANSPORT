...
void HlaPhysicalEntityImpl::setCreateAttributes(
    ...
    try {
        ...
        HlaExceptionPtr ex(new HlaInternalException(L"Failed to set create attributes in HlaPhysicalEntityImpl" + e.what_w()));
