 ...
 */
#ifndef DEVELOPER_STUDIO_HLADYNAMICALENTITYATTRIBUTESIMPL_H
#define DEVELOPER_STUDIO_HLADYNAMICALENTITYATTRIBUTESIMPL_H
...
namespace LunarSimulation {
    ...
    class HlaDynamicalEntityAttributesImpl : public HlaDynamicalEntityAttributes {
    public:
