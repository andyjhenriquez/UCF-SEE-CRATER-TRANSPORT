...
***********************************************************************/
#ifndef DS_DRIVER_RTI_BasicDataElements_h_
#define DS_DRIVER_RTI_BasicDataElements_h_
...
class EncodableDataType##Implementation;                                      \
                                                                              \
class RTIDRIVER_EXPORT EncodableDataType : public EncodingHelpers::DataElement \
{                                                                             \
public:                                                                       \
                                                                              \
   /* Constructor: Default                                                 */ \
   ...
   virtual VariableLengthData encode () const  RTI_DRIVER_THROW_SPEC(EncoderException);  \
                                                                              \
...
namespace EncodingHelpers {
   ...
   DEFINE_ENCODING_HELPER_CLASS( OMT13string, std::string )
   DEFINE_ENCODING_HELPER_CLASS( OMT13boolean, bool )

   DEFINE_ENCODING_HELPER_CLASS( UnsignedInteger64BE, UnsignedInteger64 )
   DEFINE_ENCODING_HELPER_CLASS( UnsignedInteger32BE, UnsignedInteger32 )
   DEFINE_ENCODING_HELPER_CLASS( UnsignedInteger16BE, UnsignedInteger16 )
   DEFINE_ENCODING_HELPER_CLASS( UnsignedShort, UnsignedInteger16 )

}

#endif // DS_DRIVER_RTI_BasicDataElements_h_
