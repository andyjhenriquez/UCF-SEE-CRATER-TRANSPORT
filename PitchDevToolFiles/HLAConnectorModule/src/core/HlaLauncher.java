 ...
 */
public interface HlaLauncher extends HlaLauncherAttributes, HlaObjectInstanceBase {


   /**
    * Tells if this HlaLauncher object instance is local or remote.
    ...
    */
    HlaLauncherAttributes getHlaLauncherAttributes();
    ...
    */
    HlaLauncherUpdater getHlaLauncherUpdater();
    ...
    * To make sure that no attribute updates arrive before adding the listener, use: {@link core.HlaLauncherManager#addHlaLauncherDefaultInstanceListener(HlaLauncherListener listener)}.
    *
    * @param listener The listener to add.
    */
    void addHlaLauncherListener(HlaLauncherListener listener);
    ...
    */
    void removeHlaLauncherListener(HlaLauncherListener listener);
    ...
    * This method is idempotent.
    * To make sure that no attribute updates arrive before adding the listener, use: {@link core.HlaLauncherManager#addHlaLauncherDefaultInstanceValueListener(HlaLauncherValueListener valueListener)}.
    *
    * @param valueListener The valueListener to add.
    */
    void addHlaLauncherValueListener(HlaLauncherValueListener valueListener);
    ...
    */
    void removeHlaLauncherValueListener(HlaLauncherValueListener valueListener);
