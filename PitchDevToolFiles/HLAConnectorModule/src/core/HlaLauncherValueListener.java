 ...
 */
public interface HlaLauncherValueListener {
    ...
    */
    void positionUpdated(HlaLauncher launcher, double[/* 3 */] position, boolean validOldPosition, double[/* 3 */] oldPosition, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void massUpdated(HlaLauncher launcher, double mass, boolean validOldMass, double oldMass, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param oldEnergy   The old value of the attribute
    * @param timeStamp  The time when the update was initiated.
    * @param logicalTime The logical time when the update was initiated.
    */
    void energyUpdated(HlaLauncher launcher, double energy, boolean validOldEnergy, double oldEnergy, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void nameUpdated(HlaLauncher launcher, String name, boolean validOldName, String oldName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void typeUpdated(HlaLauncher launcher, String type, boolean validOldType, String oldType, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void statusUpdated(HlaLauncher launcher, String status, boolean validOldStatus, String oldStatus, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void parentReferenceFrameUpdated(HlaLauncher launcher, String parentReferenceFrame, boolean validOldParentReferenceFrame, String oldParentReferenceFrame, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void stateUpdated(HlaLauncher launcher, SpaceTimeCoordinateState state, boolean validOldState, SpaceTimeCoordinateState oldState, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void accelerationUpdated(HlaLauncher launcher, double[/* 3 */] acceleration, boolean validOldAcceleration, double[/* 3 */] oldAcceleration, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
...
projected.
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void rotationalAccelerationUpdated(HlaLauncher launcher, double[/* 3 */] rotationalAcceleration, boolean validOldRotationalAcceleration, double[/* 3 */] oldRotationalAcceleration, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void centerOfMassUpdated(HlaLauncher launcher, double[/* 3 */] centerOfMass, boolean validOldCenterOfMass, double[/* 3 */] oldCenterOfMass, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void bodyWrtStructuralUpdated(HlaLauncher launcher, AttitudeQuaternion bodyWrtStructural, boolean validOldBodyWrtStructural, AttitudeQuaternion oldBodyWrtStructural, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void producingFederateUpdated(HlaLauncher launcher, HlaLauncherAttributes.Attribute attribute, HlaFederateId oldProducingFederate, HlaFederateId newProducingFederate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);

   /**
    * An abstract adapter class that implements the HlaLauncherValueListener interface with empty methods.
    * It might be used as a base class for a listener.
    */
    public abstract static class Adapter implements HlaLauncherValueListener {
        public void positionUpdated(HlaLauncher launcher, double[/* 3 */] position, boolean validOldPosition, double[/* 3 */] oldPosition, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void massUpdated(HlaLauncher launcher, double mass, boolean validOldMass, double oldMass, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void energyUpdated(HlaLauncher launcher, double energy, boolean validOldEnergy, double oldEnergy, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void nameUpdated(HlaLauncher launcher, String name, boolean validOldName, String oldName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void typeUpdated(HlaLauncher launcher, String type, boolean validOldType, String oldType, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void statusUpdated(HlaLauncher launcher, String status, boolean validOldStatus, String oldStatus, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void parentReferenceFrameUpdated(HlaLauncher launcher, String parentReferenceFrame, boolean validOldParentReferenceFrame, String oldParentReferenceFrame, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void stateUpdated(HlaLauncher launcher, SpaceTimeCoordinateState state, boolean validOldState, SpaceTimeCoordinateState oldState, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void accelerationUpdated(HlaLauncher launcher, double[/* 3 */] acceleration, boolean validOldAcceleration, double[/* 3 */] oldAcceleration, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void rotationalAccelerationUpdated(HlaLauncher launcher, double[/* 3 */] rotationalAcceleration, boolean validOldRotationalAcceleration, double[/* 3 */] oldRotationalAcceleration, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void centerOfMassUpdated(HlaLauncher launcher, double[/* 3 */] centerOfMass, boolean validOldCenterOfMass, double[/* 3 */] oldCenterOfMass, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void bodyWrtStructuralUpdated(HlaLauncher launcher, AttitudeQuaternion bodyWrtStructural, boolean validOldBodyWrtStructural, AttitudeQuaternion oldBodyWrtStructural, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void producingFederateUpdated(HlaLauncher instance, HlaLauncherAttributes.Attribute attribute, HlaFederateId oldProducingFederate, HlaFederateId newProducingFederate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
    }
}
