...
public interface HlaDynamicalEntity extends HlaDynamicalEntityAttributes, HlaObjectInstanceBase {
    ...
    * To make sure that no attribute updates arrive before adding the listener, use: {@link core.HlaDynamicalEntityManager#addHlaDynamicalEntityDefaultInstanceListener(HlaDynamicalEntityListener listener)}.
    *
    ...
    * This method is idempotent.
    * To make sure that no attribute updates arrive before adding the listener, use: {@link core.HlaDynamicalEntityManager#addHlaDynamicalEntityDefaultInstanceValueListener(HlaDynamicalEntityValueListener valueListener)}.
    *
