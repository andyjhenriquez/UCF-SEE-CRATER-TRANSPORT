 ...
 */
public interface HlaMoon extends HlaMoonAttributes, HlaObjectInstanceBase {


   /**
    * Tells if this HlaMoon object instance is local or remote.
    ...
    */
    HlaMoonAttributes getHlaMoonAttributes();
    ...
    */
    HlaMoonUpdater getHlaMoonUpdater();
    ...
    * To make sure that no attribute updates arrive before adding the listener, use: {@link core.HlaMoonManager#addHlaMoonDefaultInstanceListener(HlaMoonListener listener)}.
    *
    * @param listener The listener to add.
    */
    void addHlaMoonListener(HlaMoonListener listener);
    ...
    */
    void removeHlaMoonListener(HlaMoonListener listener);
    ...
    * This method is idempotent.
    * To make sure that no attribute updates arrive before adding the listener, use: {@link core.HlaMoonManager#addHlaMoonDefaultInstanceValueListener(HlaMoonValueListener valueListener)}.
    *
    * @param valueListener The valueListener to add.
    */
    void addHlaMoonValueListener(HlaMoonValueListener valueListener);
    ...
    */
    void removeHlaMoonValueListener(HlaMoonValueListener valueListener);
