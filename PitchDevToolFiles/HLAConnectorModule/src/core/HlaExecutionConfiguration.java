...
public interface HlaExecutionConfiguration extends HlaExecutionConfigurationAttributes, HlaObjectInstanceBase {
    ...
    * To make sure that no attribute updates arrive before adding the listener, use: {@link core.HlaExecutionConfigurationManager#addHlaExecutionConfigurationDefaultInstanceListener(HlaExecutionConfigurationListener listener)}.
    *
    ...
    * This method is idempotent.
    * To make sure that no attribute updates arrive before adding the listener, use: {@link core.HlaExecutionConfigurationManager#addHlaExecutionConfigurationDefaultInstanceValueListener(HlaExecutionConfigurationValueListener valueListener)}.
    *
