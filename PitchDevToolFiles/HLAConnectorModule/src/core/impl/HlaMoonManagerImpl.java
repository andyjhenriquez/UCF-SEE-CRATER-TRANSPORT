...
/* @ThreadSafe */
final class HlaMoonManagerImpl extends AbstractObjectClassManager implements HlaMoonManager {

   private static final String HLA_OBJECT_CLASS_NAME = "HLAobjectRoot.ReferenceFrame.Moon";
   ...
   private final Map<String, HlaMoonImpl> _hlaInstanceNameMap = new ConcurrentHashMap<String, HlaMoonImpl>();
   private final Map<ByteBuffer, HlaMoonImpl> _encodedHlaInstanceHandleMap = new ConcurrentHashMap<ByteBuffer, HlaMoonImpl>();
   private final Map<ObjectInstanceHandle, HlaMoonImpl> _localInstances =
         new ConcurrentHashMap<ObjectInstanceHandle, HlaMoonImpl>();
   private final Map<ObjectInstanceHandle, HlaMoonImpl> _remoteInstances =
         new ConcurrentHashMap<ObjectInstanceHandle, HlaMoonImpl>();

   private final Set<HlaMoonManagerListener> _listeners =
         new CopyOnWriteArraySet<HlaMoonManagerListener>();

   private final Set<HlaMoonValueListener> _defaultInstanceValueListeners =
         new CopyOnWriteArraySet<HlaMoonValueListener>();
   private final Set<HlaMoonListener> _defaultInstanceListeners =
         new CopyOnWriteArraySet<HlaMoonListener>();
   ...
   HlaMoonManagerImpl(HlaWorldImpl world, ObjectManager objectManager) {
   ...
   /*
    * HlaMoonManager interface impl
    */

   public List<HlaMoon> getHlaMoons() {
      return getAllHlaMoons();
   }

   public List<HlaMoon> getAllHlaMoons() {
      List<HlaMoon> list = new ArrayList<HlaMoon>(_localInstances.size() + _remoteInstances.size());
      list.addAll(_localInstances.values());
      list.addAll(_remoteInstances.values());
      return list;
   }

   public List<HlaMoon> getLocalHlaMoons() {
      return new ArrayList<HlaMoon>(_localInstances.values());
   }

   public List<HlaMoon> getRemoteHlaMoons() {
      return new ArrayList<HlaMoon>(_remoteInstances.values());
   }

   public HlaMoonImpl getMoonByHlaInstanceName(String hlaInstanceName) {
      return _hlaInstanceNameMap.get(hlaInstanceName);
   }

   public HlaMoon getMoonByHlaInstanceHandle(byte[] encodedHlaInstanceHandle) {
      return _encodedHlaInstanceHandleMap.get(ByteBuffer.wrap(encodedHlaInstanceHandle));
   }

   public HlaMoon createLocalHlaMoon(
   ...
   private HlaMoon createLocalInstance(
      ...
      for (HlaMoonListener instanceListener : _defaultInstanceListeners) {
         instance.addHlaMoonListener(instanceListener);
      }
      for (HlaMoonValueListener instanceValueListener : _defaultInstanceValueListeners) {
         instance.addHlaMoonValueListener(instanceValueListener);
      }
   ...
   public HlaMoon deleteLocalHlaMoon(HlaMoon instance)
         throws HlaNotConnectedException, HlaInternalException, HlaRtiException,
                HlaSaveInProgressException, HlaRestoreInProgressException {
      try {
         return deleteHlaMoon(instance, _worldImpl.getCurrentTime(), _worldImpl.getDefaultSendTime(), true);
   ...
   public HlaMoon deleteLocalHlaMoon(HlaMoon instance, HlaTimeStamp timestamp)
         throws HlaNotConnectedException, HlaInternalException, HlaRtiException,
                HlaSaveInProgressException, HlaRestoreInProgressException {
      try {
         return deleteHlaMoon(instance, timestamp, _worldImpl.getDefaultSendTime(), true);
      } catch (HlaInvalidLogicalTimeException e) {
         throw new HlaInternalException("Failed to delete instance with default Logical Time", e);
      }
   }

   public HlaMoon deleteLocalHlaMoon(HlaMoon instance, HlaLogicalTime logicalTime)
         throws HlaNotConnectedException, HlaInvalidLogicalTimeException, HlaInternalException, HlaRtiException,
                HlaSaveInProgressException, HlaRestoreInProgressException {
      return deleteHlaMoon(instance, _worldImpl.getCurrentTime(), logicalTime, true);
   }

   public HlaMoon deleteLocalHlaMoon(HlaMoon instance, HlaTimeStamp timestamp, HlaLogicalTime logicalTime)
         throws HlaNotConnectedException, HlaInvalidLogicalTimeException, HlaInternalException, HlaRtiException,
                HlaSaveInProgressException, HlaRestoreInProgressException {
      return deleteHlaMoon(instance, timestamp, logicalTime, true);
   }

   private HlaMoon deleteHlaMoon(HlaMoon instance, HlaTimeStamp timestamp, HlaLogicalTime logicalTime, boolean checkLocal)
         throws HlaNotConnectedException, HlaInvalidLogicalTimeException, HlaInternalException, HlaRtiException,
                HlaSaveInProgressException, HlaRestoreInProgressException {
      ...
      HlaMoonImpl instanceImpl = (HlaMoonImpl) instance;
   ...
   public void addHlaMoonManagerListener(HlaMoonManagerListener listener) {
       if (listener == null) {
   ...
   public void removeHlaMoonManagerListener(HlaMoonManagerListener listener) {
       if (listener == null) {
           throw new NullPointerException();
       }
   ...
   public void addHlaMoonDefaultInstanceListener(HlaMoonListener listener) {
      if (listener == null) {
         throw new NullPointerException();
      }
   ...
   public void addHlaMoonDefaultInstanceValueListener(HlaMoonValueListener valueListener) {
   ...
   public void removeHlaMoonDefaultInstanceListener(HlaMoonListener listener) {
      if (listener == null) {
         throw new NullPointerException();
      }
   ...
   public void removeHlaMoonDefaultInstanceValueListener(HlaMoonValueListener valueListener) {
      if (valueListener == null) {
         throw new NullPointerException();
      }
   ...
   public void discoverObjectInstance(final ObjectInstanceHandle objectInstanceHandle, String instanceName, HlaTimeStamp timeStamp, HlaFederateId producingFederate) {
      final HlaMoonImpl instance = createObjectInstance(objectInstanceHandle, false, producingFederate);
      _remoteInstances.put(objectInstanceHandle, instance);
      _hlaInstanceNameMap.put(instance.getHlaInstanceName(), instance);
      _encodedHlaInstanceHandleMap.put(ByteBuffer.wrap(instance.getEncodedHlaObjectInstanceHandle()), instance);
      fireDiscovered(instance, timeStamp);

      for (HlaMoonListener listener : _defaultInstanceListeners) {
         instance.addHlaMoonListener(listener);
      }
      for (HlaMoonValueListener listener : _defaultInstanceValueListeners) {
         instance.addHlaMoonValueListener(listener);
      }
   ...
   public void reflectAttributeValues(ObjectInstanceHandle objectInstanceHandle, NameValueMap attributes, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime, HlaFederateId producingFederate) {
      HlaMoonImpl instance = _remoteInstances.get(objectInstanceHandle);
      if (instance != null) {
   ...
   public void removeObjectInstance(ObjectInstanceHandle objectInstanceHandle, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {
      HlaMoonImpl instance = _remoteInstances.remove(objectInstanceHandle);
   ...
   public void connected(ObjectClassHandle objectClassHandle, String objectClassName)
      ...
      _objectManager.publish(_objectClassHandle, HlaMoonImpl.HLA_ATTRIBUTE_NAMES);
      _objectManager.subscribe(_objectClassHandle, HlaMoonImpl.HLA_ATTRIBUTE_NAMES);
   }

   private void clearAllInstances(boolean doFireDeleted) {
      HlaTimeStamp timeStamp = _worldImpl.getCurrentTime();

      for (Iterator<HlaMoonImpl> iterator = MapAdapter.concat(_localInstances.values().iterator(), _remoteInstances.values().iterator()); iterator.hasNext();) {
         HlaMoonImpl instance = iterator.next();
         iterator.remove();
         instance.setRemoved();
         if (doFireDeleted) {
   ...
   /*
    * Functions called from HlaMoonImpl
    */

   void updateAttributeValues(HlaMoonImpl instance, ObjectInstanceHandle objectInstanceHandle, NameValueMap attributes, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime)
   ...
   private HlaMoonImpl createObjectInstance(ObjectInstanceHandle objectInstanceHandle, boolean isLocal, HlaFederateId producingFederate) {
      return new HlaMoonImpl(_worldImpl, this, objectInstanceHandle, isLocal, producingFederate);
   }

   private void checkInitializedFired(HlaMoonImpl instance, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {
   ...
   private void fireDiscovered(final HlaMoon instance, final HlaTimeStamp timeStamp) {
      for (final HlaMoonManagerListener listener : _listeners) {
         _worldImpl.postNotification(new Runnable() {
            public void run() {
               listener.hlaMoonDiscovered(instance, timeStamp);
            }
         });
      }
   }

   private void fireDeleted(final HlaMoon instance, final HlaTimeStamp timeStamp, final HlaLogicalTime logicalTime) {
      for (final HlaMoonManagerListener listener : _listeners) {
         _worldImpl.postNotification(new Runnable() {
            public void run() {
               listener.hlaMoonDeleted(instance, timeStamp, logicalTime);
            }
         });
      }
   }

   private void fireInitialized(final HlaMoon instance, final HlaTimeStamp timeStamp, final HlaLogicalTime logicalTime) {
      for (final HlaMoonManagerListener listener : _listeners) {
         _worldImpl.postNotification(new Runnable() {
            public void run() {
               listener.hlaMoonInitialized(instance, timeStamp, logicalTime);
            }
         });
      }
   }
