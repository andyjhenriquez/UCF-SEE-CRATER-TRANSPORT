...
public interface HlaReferenceFrameUpdater extends HlaHLAobjectRootUpdater {
    ...
    * @return this updater
    */
    HlaReferenceFrameUpdater setName(String name);
    ...
    * @return this updater
    */
    HlaReferenceFrameUpdater setParentName(String parentName);
    ...
    * @return this updater
    */
    HlaReferenceFrameUpdater setState(SpaceTimeCoordinateState state);
