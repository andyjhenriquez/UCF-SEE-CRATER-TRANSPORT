...
public interface HlaPhysicalEntity extends HlaPhysicalEntityAttributes, HlaObjectInstanceBase {
    ...
    * To make sure that no attribute updates arrive before adding the listener, use: {@link core.HlaPhysicalEntityManager#addHlaPhysicalEntityDefaultInstanceListener(HlaPhysicalEntityListener listener)}.
    *
    ...
    * This method is idempotent.
    * To make sure that no attribute updates arrive before adding the listener, use: {@link core.HlaPhysicalEntityManager#addHlaPhysicalEntityDefaultInstanceValueListener(HlaPhysicalEntityValueListener valueListener)}.
    *
