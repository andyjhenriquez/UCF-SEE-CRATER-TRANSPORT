 ...
 */
public interface HlaPhysicalInterfaceValueListener {
    ...
    */
    void nameUpdated(HlaPhysicalInterface physicalInterface, String name, boolean validOldName, String oldName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void parentNameUpdated(HlaPhysicalInterface physicalInterface, String parentName, boolean validOldParentName, String oldParentName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void positionUpdated(HlaPhysicalInterface physicalInterface, double[/* 3 */] position, boolean validOldPosition, double[/* 3 */] oldPosition, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param oldAttitude   The old value of the attribute
    * @param timeStamp  The time when the update was initiated.
    * @param logicalTime The logical time when the update was initiated.
    */
    void attitudeUpdated(HlaPhysicalInterface physicalInterface, AttitudeQuaternion attitude, boolean validOldAttitude, AttitudeQuaternion oldAttitude, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void producingFederateUpdated(HlaPhysicalInterface physicalInterface, HlaPhysicalInterfaceAttributes.Attribute attribute, HlaFederateId oldProducingFederate, HlaFederateId newProducingFederate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);

   /**
    * An abstract adapter class that implements the HlaPhysicalInterfaceValueListener interface with empty methods.
    * It might be used as a base class for a listener.
    */
    public abstract static class Adapter implements HlaPhysicalInterfaceValueListener {
        public void nameUpdated(HlaPhysicalInterface physicalInterface, String name, boolean validOldName, String oldName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void parentNameUpdated(HlaPhysicalInterface physicalInterface, String parentName, boolean validOldParentName, String oldParentName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void positionUpdated(HlaPhysicalInterface physicalInterface, double[/* 3 */] position, boolean validOldPosition, double[/* 3 */] oldPosition, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void attitudeUpdated(HlaPhysicalInterface physicalInterface, AttitudeQuaternion attitude, boolean validOldAttitude, AttitudeQuaternion oldAttitude, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void producingFederateUpdated(HlaPhysicalInterface instance, HlaPhysicalInterfaceAttributes.Attribute attribute, HlaFederateId oldProducingFederate, HlaFederateId newProducingFederate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
    }
}
