 ...
 */
public interface HlaPayloadAttributes extends HlaDynamicalEntityAttributes {
   ...
   */
    ...
    * @param defaultValue default value
    *
    * @return the <code>velocity</code> attribute or <code>defaultValue</code> if not set
    */
    double[/* 3 */] getVelocity(double[/* 3 */] defaultValue);
    ...
    * @param defaultValue default value
    *
    * @return the <code>health</code> attribute or <code>defaultValue</code> if not set
    */
