 ...
 */
public interface HlaMoonValueListener {
    ...
    */
    void nameUpdated(HlaMoon moon, String name, boolean validOldName, String oldName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void parentNameUpdated(HlaMoon moon, String parentName, boolean validOldParentName, String oldParentName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void stateUpdated(HlaMoon moon, SpaceTimeCoordinateState state, boolean validOldState, SpaceTimeCoordinateState oldState, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void producingFederateUpdated(HlaMoon moon, HlaMoonAttributes.Attribute attribute, HlaFederateId oldProducingFederate, HlaFederateId newProducingFederate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);

   /**
    * An abstract adapter class that implements the HlaMoonValueListener interface with empty methods.
    * It might be used as a base class for a listener.
    */
    public abstract static class Adapter implements HlaMoonValueListener {
        public void nameUpdated(HlaMoon moon, String name, boolean validOldName, String oldName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void parentNameUpdated(HlaMoon moon, String parentName, boolean validOldParentName, String oldParentName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void stateUpdated(HlaMoon moon, SpaceTimeCoordinateState state, boolean validOldState, SpaceTimeCoordinateState oldState, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void producingFederateUpdated(HlaMoon instance, HlaMoonAttributes.Attribute attribute, HlaFederateId oldProducingFederate, HlaFederateId newProducingFederate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
    }
}
