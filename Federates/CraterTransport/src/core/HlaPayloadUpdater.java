 ...
 */
public interface HlaPayloadUpdater extends HlaDynamicalEntityUpdater {
    ...
    * @return this updater
    */
    HlaPayloadUpdater setPosition(double[/* 3 */] position);

   /**
    * Set the velocity for this update.
    ...
    * @return this updater
    */
    HlaPayloadUpdater setVelocity(double[/* 3 */] velocity);

   /**
    * Set the health for this update.
    ...
    * @return this updater
    */
    HlaPayloadUpdater setHealth(double health);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setForce(double[/* 3 */] force);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setTorque(double[/* 3 */] torque);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setMass(double mass);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setMassRate(double massRate);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setInertia(double[/* 9 */] inertia);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setInertiaRate(double[/* 9 */] inertiaRate);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setName(String name);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setType(String type);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setStatus(String status);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setParentReferenceFrame(String parentReferenceFrame);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setState(SpaceTimeCoordinateState state);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setAcceleration(double[/* 3 */] acceleration);
...
projected.
    ...
    * @return this updater
    */
    HlaPayloadUpdater setRotationalAcceleration(double[/* 3 */] rotationalAcceleration);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setCenterOfMass(double[/* 3 */] centerOfMass);
    ...
    * @return this updater
    */
    HlaPayloadUpdater setBodyWrtStructural(AttitudeQuaternion bodyWrtStructural);
